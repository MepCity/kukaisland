...
- [x] İki otomatik worker gerçek iki PHP süreciyle yarıştırıldı: ilk turda `createOrder_across_processes:1`, `createbarcode_across_processes:0`, kaybeden `dispatch_in_progress` ile yazmadan çıkıyor, `attempts_total:1`, yalnız `create_order` faz kaydı korunuyor, ayrı barkod işi `1`, yürütme kilidi sonunda serbest
