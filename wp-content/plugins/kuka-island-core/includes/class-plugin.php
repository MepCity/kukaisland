...
final class Kuka_Island_Core_Plugin {
	...
	public function boot(): void {
		...
		$this->modules = array(
			...
			new Kuka_Island_Core_Community_Gallery(),
			...
			new Kuka_Island_Core_Contact_Form(),
			new Kuka_Island_Core_Email_Design(),
