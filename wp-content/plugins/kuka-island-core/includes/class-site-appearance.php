...
final class Kuka_Island_Core_Site_Appearance {
	...
	public static function defaults(): array {
		return array(
			...
			'navigation' => array(
				'main' => "YENİ|/magaza/?orderby=date\nHİKAYEMİZ|/hakkimizda/",
				'categories' => "BİKİNİ|/kategori/bikini-ustleri/|1|1\nMAYO|/kategori/mayolar/|0|1\nPLAJ GİYİM|/kategori/plaj-giyim/|1|1\nTAKIMLAR|/kategori/takimlar/|0|1\nKOLEKSİYON|/magaza/|1|0",
	...
	private static function fields(): array {
		$groups = array(
			...
			'home'         => array(
				...
				'note'   => __( 'Hero altındaki ürün, manifesto ve hizmet bölümlerini yönetir. Müşteri fotoğrafları: Kuka Island → Sizden Gelenler. Editoryal alanlar eski içeriğin arşividir; ana sayfada kullanılmaz.', 'kuka-island-core' ),
				'fields' => array(
					...
					'editorial_enabled' => array( __( 'Eski içerik (arşiv): Editoryal bölümü göster', 'kuka-island-core' ), 'checkbox' ),
					'editorial_title'    => array( __( 'Eski içerik (arşiv): Editoryal başlık', 'kuka-island-core' ), 'text' ),
					'editorial_copy'     => array( __( 'Eski içerik (arşiv): Editoryal metin', 'kuka-island-core' ), 'textarea' ),
					'editorial_image_id' => array( __( 'Eski içerik (arşiv): Editoryal görsel', 'kuka-island-core' ), 'media_image' ),
					'editorial_video_id' => array( __( 'Eski içerik (arşiv): Editoryal video', 'kuka-island-core' ), 'media_video' ),
					'editorial_url'      => array( __( 'Eski içerik (arşiv): Editoryal URL', 'kuka-island-core' ), 'url' ),
					'editorial_link_label' => array( __( 'Eski içerik (arşiv): Editoryal bağlantı etiketi', 'kuka-island-core' ), 'text' ),
