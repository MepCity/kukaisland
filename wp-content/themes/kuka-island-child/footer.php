...
<footer class="kuka-footer">
	...
	<div class="kuka-footer-bottom"><div><a class="kuka-logo" href="<?php echo esc_url( home_url( '/' ) ); ?>">KUKA ISLAND</a><p><?php echo esc_html( $site_content['footer']['brand_copy'] ?? '' ); ?></p><p><a href="mailto:<?php echo esc_attr( $site_content['brand']['email'] ?? '' ); ?>"><?php echo esc_html( $site_content['brand']['email'] ?? '' ); ?></a> · <a href="tel:<?php echo esc_attr( preg_replace( '/[^0-9+]/', '', $site_content['brand']['phone'] ?? '' ) ); ?>"><?php echo esc_html( $site_content['brand']['phone'] ?? '' ); ?></a><?php if ( ! empty( $site_content['brand']['whatsapp_url'] ) ) : ?> · <a href="<?php echo esc_url( $site_content['brand']['whatsapp_url'] ); ?>" rel="noopener">WhatsApp ↗</a><?php endif; ?></p></div><div><p><?php echo esc_html( $site_content['legal']['company_title'] ?? '' ); ?></p><p><?php echo esc_html( $site_content['legal']['address'] ?? '' ); ?></p></div><p>© <?php echo esc_html( gmdate( 'Y' ) ); ?> Kuka Island</p></div>
</footer>
<?php wp_footer(); ?>
</body></html>
