...
<footer class="kuka-footer">
	...
	<section class="kuka-footer-links">
		...
		<div><p class="kuka-footer-title"><?php esc_html_e( 'Sosyal', 'kuka-island' ); ?></p><ul><?php foreach ( $social_links as $item ) : ?><li><a href="<?php echo esc_url( kuka_island_content_url( $item['url'] ) ); ?>" target="_blank" rel="noopener"><?php echo esc_html( $item['label'] ); ?> ↗</a></li><?php endforeach; ?><?php if ( $whatsapp_url ) : ?><li><a href="<?php echo esc_url( $whatsapp_url ); ?>" target="_blank" rel="noopener">WhatsApp ↗</a></li><?php endif; ?></ul></div>
	</section>
