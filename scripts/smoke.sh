...
grep -q 'kuka-island-catalog-css' "$temporary_dir/product.html" || fail "related product card stylesheet"
grep -q 'kuka-island-catalog-js' "$temporary_dir/product.html" || fail "related product card controls"
pass "product page loads related-card assets"
