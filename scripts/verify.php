...
WP_CLI::line( 'HOME_HERO_VIDEO=' . ( str_contains( $front_source, 'class="kuka-hero__video" autoplay loop muted playsinline' ) && str_contains( $front_source, 'coming-soon-mobile.mp4' ) && str_contains( $front_source, 'coming-soon-desktop.mp4' ) && str_contains( $global_source, '@media (prefers-reduced-motion: reduce)' ) && str_contains( $global_source, '.kuka-hero__video' ) ? 'responsive+muted+poster-fallback' : 'missing' ) );
