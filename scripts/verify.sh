...
expect_line "measured Site Appearance inventory" "SITE_APPEARANCE_INVENTORY=13_groups|115_rows|157_controls"
...
expect_line "all Site Appearance English fields seeded" "SITE_APPEARANCE_EN_VALUES=42/42"
