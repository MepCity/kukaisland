...
- Faz 8 kart şeridi resmî fakat yalnız 200×21 px raster kaynaktır. 27 CSS px şeritte Visa 19,29 CSS px/5,10 mm koşulunu karşılar; 2× retina için kaynak çözünürlüğü yetersizdir ve onaylı vektör/2× kaynak iyzico'dan beklenir.
