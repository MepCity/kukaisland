...
7. **Ticari Bilgiler:** standart kargo ücreti, ücretsiz kargo eşiği, kupon indiriminin eşikten önce/sonra uygulanması, kargo firması, tahmini süre, `cayma_hakki_gun`, hijyen metinleri ve iade kargo sorumluluğu. Varsayılan “indirimden sonraki tutar”dır (`ignore_discounts=no`). Bu değerler SSS, kargo, iade ve yasal metinlerde otomatik kullanılır; kargo ücreti/eşiği ve kupon tabanı WooCommerce yöntemlerine de yazılır.
