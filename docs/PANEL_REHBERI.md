...
Günlük kullanıcı `kuka_manager` hesabıyla giriş yapar. Sol menüden **Kuka Island → Site Görünümü** açılır. Sayfanın altındaki **Site görünümünü kaydet** düğmesi nonce ve `manage_woocommerce` yetkisiyle çalışır.
