...
7. **Ticari Bilgiler:** standart kargo ücreti, ücretsiz kargo eşiği, kargo firması, tahmini süre, iade/değişim günü ve iade kargo sorumluluğu. Bu değerler SSS, kargo, iade ve yasal taslaklarda otomatik kullanılır; kargo ücreti/eşiği WooCommerce yöntemlerine de yazılır.
